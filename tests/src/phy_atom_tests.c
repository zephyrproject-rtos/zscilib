...
ZTEST(zsl_tests, test_phy_atom_nucl_radius)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(r, 2.137469933, 1E-6));
...
ZTEST(zsl_tests, test_phy_atom_bohr_orb_radius)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(r, 0.4409810014, 1E-6));
...
ZTEST(zsl_tests, test_phy_atom_bohr_orb_vel)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(v, 1312.6147793774928, 1E-6));
...
ZTEST(zsl_tests, test_phy_atom_bohr_orb_ener)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(e, -4.8980496069, 1E-6));
...
ZTEST(zsl_tests, test_phy_atom_rad_decay)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(qf, 41.589323317, 1E-6));
...
ZTEST(zsl_tests, test_phy_atom_bragg)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(d, 841.5549889, 1E-6));

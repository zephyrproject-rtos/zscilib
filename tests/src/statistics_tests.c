...
ZTEST(zsl_tests, test_sta_mean)
{
	...
	rc = zsl_sta_mean(&v, &m);
	zassert_true(rc == 0);
	zassert_true(val_is_equal(m, 2.0, 1E-6));
}
...
ZTEST(zsl_tests, test_sta_trim_mean)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(m, 1.875000, 1E-6));

	/* Compute the trimmed mean value for p = 50. */
	rc = zsl_sta_trim_mean(&v, 50, &m);
	zassert_true(rc == 0);
	zassert_true(val_is_equal(m, 0.0, 1E-6));
...
ZTEST(zsl_tests, test_sta_weighted_mean)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(m, 1.38, 1E-6));
...
ZTEST(zsl_tests, test_sta_time_weighted_mean)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(m, 5.166667, 1E-6));
...
ZTEST(zsl_tests, test_sta_demean)
{
	...
	for (size_t g = 0; g < v.sz; g++) {
		zassert_true(val_is_equal(u.data[g], w.data[g], 1E-6));
	}
...
ZTEST(zsl_tests, test_sta_percentile)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(val, -2.5, 1E-6));

	/* Calculate the 73 percentile. */
	rc = zsl_sta_percentile(&v, 73, &val);
	zassert_true(rc == 0);
	zassert_true(val_is_equal(val, 6.0, 1E-6));

	/* Calculate the 44 percentile. */
	rc = zsl_sta_percentile(&v, 44, &val);
	zassert_true(rc == 0);
	zassert_true(val_is_equal(val, 1.0, 1E-6));
...
ZTEST(zsl_tests, test_sta_weighted_median)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(m, -1.0, 1E-6));
...
ZTEST(zsl_tests, test_sta_quartiles)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(q1, -2.0, 1E-6));
	zassert_true(val_is_equal(q2, 1.5, 1E-6));
	zassert_true(val_is_equal(q3, 6.0, 1E-6));
}
...
ZTEST(zsl_tests, test_sta_quart_range)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(r, 8.0, 1E-6));
}
...
ZTEST(zsl_tests, test_sta_mode)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(ma.sz, 1.0, 1E-6));
	zassert_true(val_is_equal(ma.data[0], -2.0, 1E-6));

	rc = zsl_sta_mode(&vb, &mb);
	zassert_true(rc == 0);
	zassert_true(val_is_equal(mb.sz, 3.0, 1E-6));
	zassert_true(val_is_equal(mb.data[0], -2.0, 1E-6));
	zassert_true(val_is_equal(mb.data[1], 1.0, 1E-6));
	zassert_true(val_is_equal(mb.data[2], 1.5, 1E-6));
...
ZTEST(zsl_tests, test_sta_data_range)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(r, 12.0, 1E-6));
}
...
ZTEST(zsl_tests, test_sta_mean_abs_dev)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(m, 8.0 / 3.0, 1E-6));
...
ZTEST(zsl_tests, test_sta_variance)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(var, 5.9, 1E-6));
}
...
ZTEST(zsl_tests, test_sta_standard_deviation)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(var, ZSL_SQRT(5.9), 1E-6));
}
...
ZTEST(zsl_tests, test_sta_covariance)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(co, 5.0, 1E-6));
...
ZTEST(zsl_tests, test_sta_covariance_matrix)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(mb.data[0], 15.395833, 1E-6));
	zassert_true(val_is_equal(mb.data[1], 10.375000, 1E-6));
	zassert_true(val_is_equal(mb.data[2], 1.650000, 1E-6));
	zassert_true(val_is_equal(mb.data[3], 10.375000, 1E-6));
	zassert_true(val_is_equal(mb.data[4], 30.750000, 1E-6));
	zassert_true(val_is_equal(mb.data[5], -4.800000, 1E-6));
	zassert_true(val_is_equal(mb.data[6], 1.650000, 1E-6));
	zassert_true(val_is_equal(mb.data[7], -4.800000, 1E-6));
	zassert_true(val_is_equal(mb.data[8], 38.593333, 1E-6));
...
ZTEST(zsl_tests, test_sta_linear_regression)
{
	...
	zassert_true(val_is_equal(coef.slope, 61.273108, 1E-2));
	zassert_true(val_is_equal(coef.intercept, -39.063480, 1E-2));
	zassert_true(val_is_equal(coef.correlation, 0.994592, 1E-4));
#else
	zassert_true(val_is_equal(coef.slope, 61.2721865421074341, 1E-6));
	zassert_true(val_is_equal(coef.intercept, -39.061955918838656, 1E-6));
	zassert_true(val_is_equal(coef.correlation, 0.994583793576875, 1E-6));
#endif
...
ZTEST(zsl_tests_double, test_sta_mult_linear_regression)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(b.data[0], 7.617854, 1E-6));
	zassert_true(val_is_equal(b.data[1], 0.255721, 1E-6));
	zassert_true(val_is_equal(b.data[2], -0.145225, 1E-6));
	zassert_true(val_is_equal(b.data[3], -0.099143, 1E-6));
	zassert_true(val_is_equal(b.data[4], 0.137828, 1E-6));
	zassert_true(val_is_equal(r, 0.140693, 1E-6));
...
ZTEST(zsl_tests_double, test_sta_weighted_mult_linear_regression)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(b.data[0], 8.087948, 1E-6));
	zassert_true(val_is_equal(b.data[1], 0.403896, 1E-6));
	zassert_true(val_is_equal(b.data[2], -0.230993, 1E-6));
	zassert_true(val_is_equal(b.data[3], 0.142673, 1E-6));
	zassert_true(val_is_equal(b.data[4], 0.449494, 1E-6));
	zassert_true(val_is_equal(r, 0.078979, 1E-6));
...
ZTEST(zsl_tests_double, test_sta_quadric_fitting)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(b.data[0], -0.000555, 1E-6));
	zassert_true(val_is_equal(b.data[1], -0.000834, 1E-6));
	zassert_true(val_is_equal(b.data[2], -0.000977, 1E-6));
	zassert_true(val_is_equal(b.data[3], 0.000483, 1E-6));
	zassert_true(val_is_equal(b.data[4], -0.000468, 1E-6));
	zassert_true(val_is_equal(b.data[5], 0.000258, 1E-6));
	zassert_true(val_is_equal(b.data[6], 0.009216, 1E-6));
	zassert_true(val_is_equal(b.data[7], 0.004983, 1E-6));
	zassert_true(val_is_equal(b.data[8], 0.027798, 1E-6));
...
ZTEST(zsl_tests, test_sta_absolute_error)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(err, 0.0015, 1E-6));
}
...
ZTEST(zsl_tests, test_sta_relative_error)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(err, 0.015, 1E-5));
}
...
ZTEST(zsl_tests, test_sta_standard_error)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(err, 1.50554530542, 1E-6));

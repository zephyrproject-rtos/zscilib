...
ZTEST(zsl_tests, test_phy_fluid_dens)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(d, 2.65, 1E-6));
...
ZTEST(zsl_tests, test_phy_fluid_simple_press)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(p, 2.65, 1E-6));
...
ZTEST(zsl_tests, test_phy_fluid_press)
{
	...
	zassert_true(rc == 0);
 	...
 	zassert_true(val_is_equal(p, 32.7884317, 1E-5));
#else
	zassert_true(val_is_equal(p, 32.7884317, 1E-8));
#endif
...
ZTEST(zsl_tests, test_phy_fluid_bouyant_force)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(f, 12.7108527, 1E-6));
...
ZTEST(zsl_tests, test_phy_fluid_flow_rate)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(v2, 24.0, 1E-6));
...
ZTEST(zsl_tests, test_phy_fluid_force_prop)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(f2, 6.0, 1E-6));
...
ZTEST(zsl_tests, test_phy_fluid_bernoulli)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(p2, 32.234, 1E-6));
...
ZTEST(zsl_tests, test_phy_fluid_volume_flow_rate)
{
	...
	zassert_true(rc == 0);
	zassert_true(val_is_equal(v, 3.0, 1E-6));

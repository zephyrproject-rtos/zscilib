...
ZTEST(zsl_tests, test_interp_lerp)
{
	...
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(v, 0.15, 1E-4));

	/* Test 2: t = 0. */
	t = 0.0;
	rc = zsl_interp_lerp(v0, v1, t, &v);
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(v, v0, 1E-4));

	/* Test 3: t = 1.0. */
	t = 1.0;
	rc = zsl_interp_lerp(v0, v1, t, &v);
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(v, v1, 1E-4));
...
ZTEST(zsl_tests, test_interp_nn)
{
	...
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(y2, xy1.y, 1E-4));

	/* Test 2: Interpolate y at x = 15.6 */
	rc = zsl_interp_nn(&xy1, &xy3, 15.6, &y2);
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(y2, xy3.y, 1E-4));
...
ZTEST(zsl_tests, test_interp_nn_arr)
{
	...
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(y, xy[1].y, 1E-4));
}
...
ZTEST(zsl_tests, test_interp_lin_y)
{
	...
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(y2, 0.2072, 1E-4));
	...
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(y2, 0.21, 1E-4));
	xy1.x = 10.0;
	xy3.x = 20.0;
...
ZTEST(zsl_tests, test_interp_lin_y_arr)
{
	...
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(y, -2.25, 1E-4));
}
...
ZTEST(zsl_tests, test_interp_lin_x)
{
	...
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(x2, 13.6, 1E-4));
	...
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(x2, 12.5, 1E-4));
	xy1.y = 0.20;
	xy3.y = 0.22;
	...
	rc = zsl_interp_lin_x(&xy1, &xy3, xy1.y, &x2);
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(x2, xy1.x, 1E-4));

	/* Test 7: y2 == y3. */
	rc = zsl_interp_lin_x(&xy1, &xy3, xy3.y, &x2);
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(x2, xy3.x, 1E-4));
}
...
ZTEST(zsl_tests, test_interp_cubic_arr)
{
	...
	zassert_equal(rc, 0);
	zassert_true(val_is_equal(y, 1.907918, 1E-4));

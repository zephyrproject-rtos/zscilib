...
/**
 * @file
 * @brief Extended data type definitions for ZSL_DT_BASE_LIGHT.
 */

#ifndef ZEPHYR_INCLUDE_ZSL_DATATYPES_LIGHT_H_
#define ZEPHYR_INCLUDE_ZSL_DATATYPES_LIGHT_H_
...
/**
 * @brief Extended data types for ZSL_DT_BASE_LIGHT.
 *
 * Memory map:
 *   - 0 = Illuminance (lux)
 ...
 *   - 0x60..0xFE = Reserved
 *
 * <b>Radiometric Units (ZSL_DT_EXT_LIGHT_RADIO_*)</b>
 *
 ...
 *
 * <b>Photometric Units (ZSL_DT_EXT_LIGHT_PHOTO_*)</b>
 *
...
enum zsl_dt_ext_light {
	 ...
	 */
	ZSL_DT_EXT_LIGHT_RADIO_RADIANT_INTENSITY        = 0x15,

	/**
	 * @brief Radiant intensity per unit frequency. Measured in watt per
	 * steradian per hertz (W/sr/Hz).
	 */
	ZSL_DT_EXT_LIGHT_RADIO_SPECTRAL_INTENSITY_HZ    = 0x16,
	 ...
	 */
	ZSL_DT_EXT_LIGHT_RADIO_RADIOSITY                = 0x1E,

	/**
	 * @brief Radiosity of a surface per unit frequency. Measured in watt per
	 * square meter per hertz (W/m^2/Hz).
	 */
	ZSL_DT_EXT_LIGHT_RADIO_SPECTRAL_RADIOSITY_HZ    = 0x1F,
...
#endif /* ZEPHYR_INCLUDE_ZSL_DATATYPES_LIGHT_H_ */

/** @} */ /* End of DATATYPES_LIGHT group */

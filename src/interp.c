...
int
interp_lerp(zsl_real_t v0, zsl_real_t v1, zsl_real_t t, zsl_real_t *v)
{
        int rc;
...
int
interp_find_x(struct interp_xy xy[], size_t n, zsl_real_t x, int *idx)
{
        int rc;
...
int
interp_nn(struct interp_xy *xy1, struct interp_xy *xy3, zsl_real_t x2,
          zsl_real_t *y2)
{
        int rc;
        zsl_real_t delta;
...
int
interp_nn_arr(struct interp_xy xy[], size_t n, zsl_real_t x, zsl_real_t *y)
{
        int rc;
        int idx;
        ...
        rc = interp_nn(&xy[idx], &xy[idx+1], x, y);
        if (rc) {
                *y = NAN;
                goto err;
        }
...
int
interp_lin_y(struct interp_xy *xy1, struct interp_xy *xy3, zsl_real_t x2,
             zsl_real_t *y2)
{
        int rc;
        zsl_real_t delta;
...
int
interp_lin_y_arr(struct interp_xy xy[], size_t n, zsl_real_t x, zsl_real_t *y)
{
        int rc;
        int idx;
        ...
        rc = interp_lin_y(&xy[idx], &xy[idx+1], x, y);
        if (rc) {
                *y = NAN;
                goto err;
        }
...
int
interp_lin_x(struct interp_xy *xy1, struct interp_xy *xy3, zsl_real_t y2,
             zsl_real_t *x2)
{
        int rc;
...
int
interp_cubic_calc (struct interp_xyc xyc[], size_t n, zsl_real_t yp1,
                   zsl_real_t ypn)
{
        int rc;
        int i;
...
int
interp_cubic_arr(struct interp_xyc xyc[], size_t n, zsl_real_t x, zsl_real_t *y)
{
        int rc;

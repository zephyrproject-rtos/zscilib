...
This sample application shows how to use various electricity functions in
...
.. code-block:: console
    ...
    $ rm -rf build
    $ west build -b qemu_cortex_m3 modules/lib/zscilib/samples/physics/electricity/ -t run
...
.. code-block:: console
    ...
    $ west build -p -b nrf52840_pca10056 modules/lib/zscilib/samples/physics/electricity/
    $ west flash
